...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/vicwyx/V2Ray_ws-tls_bash_onekey_myOwn/master/install.sh" && chmod +x install.sh && bash install.sh
```
